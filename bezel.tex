...
modulo por medio del nombre del modulo como ocurre en la linea 12, en esta
...
de clase o de instancia. En las lineas 1-11 se define el modulo \texttt{Boolean}
el cual define dos métodos \texttt{boolean?} y \texttt{to\_bool}, mientras que
en las lineas 13-17 se define el modulo \texttt{RandomString} que define un método
...
se hace uso de \texttt{include} para agregar los métodos del modulo dado como
...
para agregar los métodos del modulo dado como métodos de clase como se puede
ver en la linea 26.
...
\item \texttt{Bezel::Associations}: modulo que define las asociaciones entre
  modelos.
...
servicio web C3, por medio del modulo \texttt{Config} se permite configurar
...
En las lineas 13-49 se tiene la implementacion del metodo \texttt{invoke}, en 
