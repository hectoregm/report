...
\texttt{Bezel::Base} pero el metodo \texttt{totalCost} igual es definido en tiempo
...
\begin{itemize}
  \item \texttt{config\_option} (lineas 6-19): este método permite la definición
    ...
    de metodo \texttt{define\_method} que permite crear métodos en tiempo
    de ejecución, con este metodo y de \texttt{attr\_writer} se definen
    metodos de acceso para atributos de clase para los modelos
\end{itemize}
