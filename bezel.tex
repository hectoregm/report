...
si es necesario.
En las lineas 13-27 se agregan métodos auxiliares de clase para operaciones de lectura, escritura y borrado de modelos en el cache.

% FIXME: Explicar la versión aumentada de all que hace uso de cache.
% FIXME: Agregar implementación de Bezel::Cache
