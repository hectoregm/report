...
\renewcommand{\refname}{5. \ Bibliografía propuesta}
\addto{\captionsspanish}{\renewcommand{\refname}{5. \ Bibliografía propuesta \vspace*{2.5mm}}}
...
\item Implementación de un sistema de despliegue continuo de la aplicación, por
  medio de la automatización máxima de todos los procesos involucrados para lograr
...
por medio de Software Next Door, compañía ganadora de dicha licitación ya
...
\item Diseño e implementación del sistema PEAT
  ...
  \item Despliegue continuo
    \begin{enumerate}[label*=\arabic*.]
    \item Computo escalable en la nube (\textit{Amazon Elastic Compute Cloud})
    \item Herramientas para automatización (\textit{RVM} y \textit{Capistrano})
    \item Definición y configuración de ambientes
    \item Ciclo típico de desarrollo y despliegue
    \end{enumerate}
  \end{enumerate}
\item Conclusiones
\item Bibliografía
