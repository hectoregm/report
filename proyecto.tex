...
Este sistema fue desarrollada siendo parte de la compañía
...
\item Implementación de un sistema de despliegue continuo de la aplicación, por
  medio de una atomización máxima de todos los pasos para lograr el despliegue
  del sistema.
...
termino un proyecto, es decir, terminarlo exitosamente.
