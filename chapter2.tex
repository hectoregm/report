...
describir el comportamiento de la interacción de un subconjunto de módulos
del sistema.
...
%% Además BDD se hace uso de lenguajes DSL que tratan de ser lo mas cercanos a un
%% lenguaje natural, generalmente siendo el ingles pero no limitado a este.
%% Haciendo uso de este lenguaje DSL se implementan pruebas de aceptación que
%% especifican el comportamiento y los resultados esperados del sistema.
...
de aceptación con el cliente y gente de negocio, lo cual no siempre es posible.

\subsubsection{Cucumber}
Cucumber es un marco de trabajo que permite el especificar y ejecutar pruebas de
aceptación siguiendo el proceso BDD. Define un lenguaje llamado Gherkin que
permite escribir escenarios en lenguaje natural. De esta manera
se puede tener que personas no técnicas, como el cliente o gente de negocio,
puedan ayudar a escribir o dar el visto bueno a las pruebas de aceptación.

Un ejemplo de una prueba de aceptación es el siguiente:
\begin{verbatim}
Característica:
...
de las pruebas unitarias y de aceptacion del sistema.
