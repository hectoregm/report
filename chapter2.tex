...
En el Cuadro \ref{table:rest} se pueden ver las rutas y métodos asociados para las principales
...
El desarrollo guiado por pruebas (\textit{Test Driven Development}, TDD) es una practica de software que involucra el escribir las pruebas antes de
