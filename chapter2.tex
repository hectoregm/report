...
En BDD se tienen pruebas de aceptación que especifican el comportamiento de
varias partes del sistema trabajando juntas.
...
Cucumber es un marco de trabajo que permite el definir y ejecutar pruebas de
aceptacion siguiendo el proceso BDD. Define un lenguaje llamado
Gherkin que permite escribir escenarios en lenguaje natural. De esta manera
se puede tener que personas no tecnicas, como el cliente o stakeholders,
puedan ayudar a escribir o dar el visto bueno a las pruebas de aceptacion.
...
Característica:
 ...
 Quiero saber sobre las posibles mejoras a mi edificio
  ...
  Esquema del escenario: Desplegar la lista de recomendaciones
    Dado que ingreso al sistema como el usuario @user1 por primera vez
