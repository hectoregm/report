...
de software para desarrollar servicios web. \texttt{REST} tiene cuatro
...
\item Representacional (\texttt{representational}): Se define la existencia
  de recursos (elementos de información). Cada recurso tiene una serie de
  representaciones posibles. Por ejemplo una lista de bugs por arreglar (recurso)
  puede ser presentado en forma de un documento XML, una pagina HTML o un archivo
  CSV (representaciones).
