...
\section{Conocimiento usado obtenido durante la carrera}

Durante la implementación del sistema \texttt{PEAT} hice uso de conocimiento obtenido
durante mi paso por la carrera de Ciencias de Computacion. Aunque no aplique
directamente el conocimiento obtenido en materias como Calculo o Lineal estas materias ayudaron a tener

De las materias vistas durante la carrera las siguiente fueron las que mas me
ayudaron en este proyecto:

\begin{itemize}
\item Lenguajes de programación: el conocimiento obtenido en esta materia sobre
  recursion, lenguajes de dominio especifico me han permitido aprender rapidamente
  nuevos lenguajes de programacion y poder usar cada lenguaje de forma optima.
\item Sistemas Operativos: me dio el conocimiento sobre el manejo de procesos
  y memoria que fue fundamental para la automatizacion y monitoreo del despliegue
  del sistema.
\item Procesos Paralelos: me dio herramientas para poder solucionar problemas
  que se presentan en sistemas distribuidos como sincronizacion de sesiones y
  de datos
\item Redes de computadoras: al tener un conocimiento de los protocolos
  TCP/IP y del protocolo HTTP permite el uso optimo de la arquitectura REST.
\item Ingenieria de Software: permitió ver la necesidad de especificar
  ciertas lagunas en los requerimientos, detectar deficiencias en los primeros
  borradores de los casos de uso del sistema y de aplicar 
  casos de uso y el concomiento de metodologias agiles.
\end{itemize}
