...
% FIXME: Rehacer el párrafo, se vuelve redundante al final
...
Aunque en la parte del \texttt{backend} se tiene un sistema de procesamiento
...
diferentes partes. %FIXME: Ser mas especifico en la desagregación.
