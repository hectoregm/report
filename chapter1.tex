...
además contaba con un sistema de monitoreo de consumo de energía enfocada
...
Estos sistemas fueron implementados usando un marco de trabajo desarrollado dentro
...
%FIXME: Falta párrafo de cierre del capitulo.
% Como se puede ver en este capitulo ...
