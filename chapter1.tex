...
Este API estaba implementado en Javascript bajo Rhino\footnote{Un interprete
  de Javascript de código abierto desarrollado en Java.}
...
críticas en un lenguaje con mejor rendimiento como lo es Java. De esta forma
...
%FIXME: Redactar mejor la parte final.
