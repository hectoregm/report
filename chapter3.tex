...
\item La pagina \textquote{Detalle recomendación} (Ver Figura 3.3 6) muestra los
...
\item Componente de ingreso progresivo: en este componente se despliega una pregunta
  ...
  se verán en detalle en la sección 3.3.8 sobre componentes reusables.
\item Componente lista de recomendaciones: en este componente se despliega la
  ...
  las características de este componente se verán a detalle en la sección 3.3.8
  sobre componente reusables.
...
para lograr ahorrar energía. En esta lista se tienen todas las recomendaciones
aplicables pero que no están en el plan de ahorro del edificio.

La pagina tiene dos secciones: la parte lateral contiene el componente de
ingreso progresivo y en la sección principal se tiene el componente lista
de recomendaciones.

El componente lista de recomendaciones consta de las siguientes partes:
...
\item Encabezado: Se tiene las características principales por las cuales
  ...
  de la inversión. La lista puede ser ordenada en base a cualquiera de estas
  características.
...
\end{enumerate}
\jcimage{0.5}{imagenes/PPW.png}{Componente de ingreso progresivo.}
