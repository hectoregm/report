...
\begin{usecase}
  ...
  \addfield{Descripción:}{Un cliente PyME tiene un edificio del
    cual quiere ver sus características básicas y detalladas
  ...
  \item El sistema checa si la cuenta tiene mas de un edificio asociado.
    ...
    \end{itemize}
  \item El sistema despliega una lista de preguntas divida en secciones.
    Las secciones completadas están marcadas con una marca de completado.
    \begin{itemize}
    \item Las secciones que se despliegan dependen del tipo de edificio, ejemplos
      son: construcción, iluminación, calefacción y refrigeración.
    \end{itemize}
  }
  \addfield{Postcondiciones:}{
