...
que es la capacidad para interactuar con la informacion sobre los gatos de
energía y el plan de ahorro para el edificio del usuario.

La pagina esta dividida en las siguientes partes:
\begin{itemize}
\item Barra de vistas de información: En esta barra el usuario puede seleccionar
  que tipo de información se despliega en las gráficas. Se tienen cuatro tipos
  ...
  (\textit{Energy Use}).
  \jcimage{0.5}{imagenes/Barra-Vistas.png}{El usuario es redirigido al plan
  de ahorro del perfil recientemente creado.}
\item Sección de gráficas: Esta sección se encuentra en la parte inferior de la
  barra de vistas
\end{itemize}
