...
\subsection{Navegación y flujo de interacción}

La experiencia de usuario esta compuesta por la navegación por ocho paginas
de las cuales tres son en paginas de PG\&E y las restantes cinco son gestionadas
por el sistema \texttt{PEAT}:

\begin{enumerate}
\item Un usuario entra al portal de PG\&E, la pagina de ingreso al sistema
  MyEnergy de PG\&E en donde los usuarios PyME hacen la administración de su
  perfil y cuentas con PG\&E. En el dashboard de MyEnergy se tiene una liga
  que invita al usuario a encontrar formas de ahorrar, esta liga dirige
  al usuario al sistema \texttt{PEAT} (Ver Figura 3.3 1).
\item El usuario en su primer ingreso al sistema \texttt{PEAT} o que no tiene
  ningún perfil de edificio creado es dirigido a la pagina \textquote{Crear perfil
    de edificio}, aquí el usuario solo contesta las preguntas básicas sobre su
  edificio. El usuario vuelve a esta pagina si quiere agregar mas edificios
  a su cuenta (Ver Figura 3.3 2). Al crear un perfil se redirige al usuario
  a su plan de ahorro.
\item El plan de ahorro es la pagina principal en el sistema \texttt{PEAT},
  es también donde los usuarios ingresan al sistema después de dar ingresar
  por medio de su dashboard en \textit{MyEnergy} y que ya cuentan por lo menos
  con un perfil de edificio. El plan de ahorro presenta dos funcionalidades
  al usuario:
  \begin{itemize}
  ...
  \item Parte inferior: se proporciona al usuario su plan de ahorro y las
    medidas que se ha comprometido a realizar para reducir su gasto.
  \end{itemize}
  El usuario puede navegar al perfil detallado del edificio o a la lista
  de recomendaciones.
\item En la pagina de recomendaciones se tiene dos componentes:
  \begin{itemize}
  ...
  \item Una lista de recomendaciones para reducir sus costos de energía
    basados en el perfil de su edificio.
  \end{itemize}
  El usuario puede navegar al detalle de una recomendación o al perfil
  de su edificio.
\item La pagina de detalle del edificio es donde el usuario puede responder
  o actualizar las respuestas a las preguntas sobre su edificio.
\item La pagina de detalle de recomendación es la pagina que muestra los
  pormenores sobre las medidas para lograr reducir su gasto y el impacto que
  se puede esperar después de su implementación.
\end{enumerate}

El flujo de interacción inicia cuando un usuario ingresa por el portal de
PG\&E (Ver Figura 3.3 1). Es usuario es redirigido al sistema \texttt{PEAT},
si este no tiene ningún perfil de edificio entonces el usuario es dirigido
a la pagina para la creación de un perfil de edificio. Después de crear
un perfil o dado que ya tenia un perfil creado anteriormente el usuario
es dirigido a su plan de ahorro.

La pagina de plan de ahorro es la pagina principal del sistema, desde la cual
se tienen acceso a las demás paginas del sistema. Dentro de la pagina del
plan de ahorro se desarrollan la mayor parte de las interacciones del usuario
puesto que se muestran todas las gráficas sobre el gasto de energía del usuario
y se da el manejo de las recomendaciones dentro de su plan de ahorro.

De la pagina de ahorro el usuario se puede dirigir al perfil detallado de su
edificio donde se tiene igual una gran cantidad de interacciones para
permitir que sea muy ágil la captura de información.

La pagina de recomendaciones se tienen la lista de recomendaciones que el
sistema tiene para el perfil del edificio del usuario.

Finalmente se tiene la pagina del detalle de una recomendación en la cual
el usuario obtiene mas información sobre los beneficios económicos, detalles
...
La pagina de \textquote{Crear perfil de edificio} es la pagina inicial
...
En la primera versión de esta pagina se tenia una sola forma que obtiene toda
la información requerida según el caso de uso \textit{Crear perfil del edificio},
pero se vio con pruebas con usuarios que esto representaba mucho trabajo al usuario
(Ver Figura 3.4).

\jcimageinline{1.0}{imagenes/SBP-Wireframe.png}{Boceto inicial para crear
  un perfil de edificio.}

Por lo que se tomo la decisión de disminuir la información requerida y dividir
el ingreso de información en dos partes.

Entonces el sistema inicialmente pide al usuario seleccionar el tipo de industria
que mejor describe su negocio, las opciones son: Comercial, Industrial,
Agricultura, Habitacional, Otro (Ver Figura 3.5).

\jcimageinline{1.0}{imagenes/SBP-Modal1.png}{Se pide al usuario
...
\jcimageinline{1.0}{imagenes/SBP-Modal2.png}{Se pide al usuario
  el seleccionar el tipo de industria de su negocio.}

Al ingresar esta información el usuario es redirigido al plan de ahorro del
perfil de edificio creado. (Ver Figura 3.6)

\jcimageinline{1.0}{imagenes/EP.png}{El usuario es redirigido al plan
