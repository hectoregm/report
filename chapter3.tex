...
\item Área de visualización: En esta sección se despliega los datos de consumo
  ...
  en los dos menús anteriores.
  \jcimage{1.0}{imagenes/Grafica.png}{Visualización del gasto de electricidad con
    comparativa del año anterior y el clima.}
\end{itemize}

Para la implementación de las gráficas se hizo el uso del marco de trabajo
\texttt{Ext JS}, este marco de trabajo esta diseñado para la implementación
de aplicaciones de tipo \textit{SPA} por medio del lenguaje de programación
Javascript. \texttt{Ext JS} implementa un gran numero de controles de interface
como paneles, sliders, etc, pero para fines del sistema \texttt{PEAT} solo
hizo uso del modulo de gráficos pues permite representar visualmente los datos
con una amplia gama de tipos de gráficos - incluyendo lineas, barras y gráficas
circulares. El modulo de graficacion hace uso de SVG, VML y Canvas para
dibujar las gráficas de esta forma las variaciones del navegador son manejados
automáticamente de tal forma que las gráficas siempre se muestran correctamente.
