...
En la primera versión de esta pagina se tenia una sola forma que
captaba toda la información requerida según el caso de uso
\textit{Crear perfil del edificio}, pero se vio con pruebas con
usuario que esto representaba una gran carga al usuario requerir
tanta informacion de un solo tajo.

Asi en el boceto de la pagina (Ver Figura 3.4) se tiene en una sola pagina
tanto el 

\jcimageinline{1.0}{imagenes/SBP-Wireframe.png}{Boceto inicial para crear
  un perfil de edificio.}

El sistema inicialmente pide al usuario seleccionar el tipo de industria
que mejor describe su negocio, las opciones son: Comercial, Industrial,
Agricultura, Habitacional, Otro (Ver Figura 3.4).

\jcimageinline{1.0}{imagenes/SBP-Modal1.png}{Se pide al usuario
  el seleccionar el tipo de industria de su negocio.}

Después el sistema pide al usuario la información sobre cuenta y la dirección
de servicio, el alias del edificio, el tipo de edificio y su área (Ver Figura 3.5).
