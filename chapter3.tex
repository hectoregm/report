...
\begin{usecase}
  \addtitle{Caso de Uso I:}{Ingresar información básica inicial}
  \addfield{Descripción:}{Foo}
  \addfield{Actor:}{Cliente}
  \addfield{Precondiciones:}{}
  \addfield{Flujo normal de eventos:}{}
  \addfield{Flujo alternativo de eventos:}{}
  \addfield{Flujo excepcional de eventos:}{}
