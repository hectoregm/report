...
el componente PPW era necesario escribir una cantidad de código Javascript
considerable, para dar estructura a estos componentes del \textit{frontend} se eligió
usar la biblioteca \textit{Backbone} puesto que permite definir una
arquitectura MVC, es decir permite definir modelos, vistas y controladores en
la parte del \textit{frontend}.
...
pruebas con usuarios, en las primeras versiones la pagina requería que el
usuario contestara toda la información requerida como se
