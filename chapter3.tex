...
del servidor están implementadas en Java. El servidor C3 puede mandar tanto XML como
JSON como respuesta a peticiones realizadas al servidor, pero la representación en
JSON es la mas usada dado que el sistema de tipos usando por el sistema esta definido
en Javascript.
...
posible, para evitar desfases entre la definición de los tipos en los dos sistemas.
...
El objetivo de la implementación de un DSL interno es para permitir la creación
de modelos en Ruby de forma eficiente, haciendo uso de que el API del servidor C3
es de tipo REST y las capacidades de metaprogramación de Ruby fue posible
construir de forma automática los tipos y sus acciones básicas de crear, leer,
actualizar y borrar (\textit{CRUD}) de los tipos del servidor C3.
