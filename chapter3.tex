...
% FIXME: Add general description about energy charts.
  ...
  \item El usuario a agregado una o mas recomendaciones a su plan de ahorro.
    ...
    \item El usuario actualiza el estado de una recomendación a
      ...
      \item Las recomendaciones dentro del plan de ahorro solo pueden tener
        dos posibles estados: \textqupte{Completada} y \textquote{Remover},
...
% FIXME: Al parecer este párrafo esta repetido.
...
\item Componente lista de recomendaciones: en este componente se despliega la
  ...
  %  FIXME: Reemplazar esta imagen por una de toda la sección inferior:
...
\item Encabezado: se muestra una descripción breve de la recomendación y a su
  derecha se tiene el componente \textquote{Añadir al plan} (Ver Figura
...
En \texttt{PEAT} se tiene varios componentes como el componente de ingreso
progresivo o el componente para añadir al plan de ahorro cuya presencia es necesaria
por la funcionalidad que proporcionan. Para permitir el reuso de código y diseño se
decidió implementar estos componentes por medio de la biblioteca
\texttt{Backbone} para facilitar su uso en diferentes páginas del sistema.
