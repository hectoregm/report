...
\begin{usecase}
  ...
  \addfield{Actor:}{Usuario PyME}
  \additemizedfield{Precondiciones:}{
  \item El usuario ha sido autentificado por medio de un element (\textit{token})
    de autenticación (\textit{Single Sign On} SSO) asignado por el sistema de PG\&E.
...
ya que entre mas información se obtiene de éstos se podrán generar mejores planes
