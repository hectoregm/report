...
\item Como un DSL para el lenguaje de programacion Ruby para la implementación rápida
...
leer, actualizar y borrar (\texit{CRUD}) para los modelos obtenidos del API.
