...
En el código anterior se tiene las tareas mas importantes definidas para el
...
de la configuración generada en la tarea anterior para iniciar o parar
...
Como se menciono antes cada ambiente tiene su propio archivo de configuracion
