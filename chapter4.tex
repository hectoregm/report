...
\item Apache Cassandra: un \textit{cluster} de diez nodos de tipo M4 ejecutando
  ...
  \item Recopilar y analizar grandes volúmenes de datos en secuencia, como el
    historial de consumo de energía obtenido por los medidores inteligentes\footnote{
      Al escribir datos en Cassandra, éstos se ordenan y se guardan
      secuencialmente en disco, por lo que para recuperar los datos solo se necesita
      la clave de fila y un rango, logrando un patrón de acceso rápido y eficiente
      \cite{33_time_series}}.
