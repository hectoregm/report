...
numero de éstas se podían evitar teniendo un repositorio de memoria de modelos que solo pueden
...
Se determino que la mejor solución fue que al iniciar el sistema \texttt{PEAT}
se precargara el repositorio de memoria con la información de los modelos descritos anteriormente
...
inicialización del sistema \texttt{PEAT} y la precarga de modelos en el repositorio de memoria.
...
\texttt{PEAT} y el repositorio de memoria de los modelos descritos anteriormente. Cada instancia
...
proceso \textit{Preloader} el cual contiene los modelos precargados en el repositorio de memoria por
lo que la inicialización de nuevas instancias es casi instantánea.

\rjcimage{1.0}{imagenes/Passenger-Cache.png}{Diagrama de la memoria compartida entre
  \textit{Preloader} y las instancias \texttt{PEAT}.}{cache}

Para la invalidación del repositorio de memoria de los modelos se tenia una acción para el
administrador del sistema que permite limpiar el repositorio de memoria y actualizar los modelos
