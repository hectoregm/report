...
El usuario tiene una cuenta, una dirección de servicio y un edificio
  ...
  Antecedentes:
    Dado que ingreso como el usuario @user1 por vez primera
  ...
  @javascript
  Scenario: Añadir una recomendación al plan de ahorro
    Dado que visito la pagina de recomendaciones
    Cuando selecciono "Añadir al plan" en la primera recomendacion
