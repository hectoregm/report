...
Se hicieron uso de los siguientes tipos de nodos:
\begin{itemize}
...
\item Nodos EC2: son servidores con capacidades de cómputo que pueden ser
  ...
  instancias del tipo \texttt{M3}. Para el servidor C3 se usan cuatro instancias de
  tipo \texttt{M4}.
...
\item Apache Cassandra: un \textit{cluster} de diez nodos de tipo M4 ejecutando
  ...
  \item Recopilar y analizar grandes volúmenes de datos en secuencia, como el
    historial de consumo de energía que se maneja para PEAT\footnote{Al escribir
      datos en Cassandra, datos se ordenan secuencialmente y escribe en el disco,
      al recuperar datos de clave de fila y luego por rango, se obtiene un patrón
      de acceso rápido y eficiente}.
